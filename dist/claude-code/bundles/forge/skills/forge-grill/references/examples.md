...
End-to-end transcripts for `/forge grill`. Condensed for readability; real
sessions include more follow-up children.

## Example 1 — Backend-only Feature

**User**: `/forge grill add batch export to orders API`
...
**User**: `/forge grill refactor tier routing to support project_phase hints`
