...
import { detectTruncation, REPORT_END_MARKER, REPORT_START_MARKER, } from "../src/truncation-detection.js";
// ---------------------------------------------------------------------------
// Fixtures
// ---------------------------------------------------------------------------
...
describe("detectTruncation", () => {
    ...
    it("preserves the layer parameter in the result", () => {
        const layers = ["spec", "quality", "security"];
...
//# sourceMappingURL=truncation-detection.test.js.map