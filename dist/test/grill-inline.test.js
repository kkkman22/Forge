...
describe("formatInlineGrillInjection", () => {
    it("formats completed result for spec mode", () => {
        const result = formatInlineGrillInjection({ kind: "completed", tree: {}, alignmentSummary: "3 items clarified" }, "spec");
    ...
    it("formats completed result for decide mode", () => {
        const result = formatInlineGrillInjection({ kind: "completed", tree: {}, alignmentSummary: "requirements aligned" }, "decide");
        expect(result).toContain("Inline Grill 对齐结果");
...
//# sourceMappingURL=grill-inline.test.js.map