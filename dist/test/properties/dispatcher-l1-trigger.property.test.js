...
describe("R2.2: dispatcher L1 trigger property", () => {
    ...
    it("for any single L1 trigger reason, probe reports that exact reason", {
        ...
        fc.assert(fc.property(fc.constantFrom(...L1_REASONS), (reason) => {
            delete process.env.CLAUDE_CODE_WORKFLOWS;
            ...
            try {
                ...
                if (!probe.eligible) {
                    await dispatch(ctx, {
                        ...
                        const validReasons = new Set(L1_REASONS);
...
//# sourceMappingURL=dispatcher-l1-trigger.property.test.js.map