...
function makeFeatureBundle(feature) {
    const requirements = {
        frontmatter: {
            feature,
            status: "draft",
...
function makeBugfixBundle(feature) {
    const bugfix = {
        frontmatter: {
            feature,
            status: "draft",
...
describe("routeSpecEntry — import branch", () => {
    it("dispatches to runImportMode when argv[0] is an existing file", () => {
        ...
        writeFileSync(externalPath, "# External Product Spec\n\n" +
            "## Acceptance Criteria\n\n" +
            "- 当 用户提交 时 系统应当 返回成功\n", "utf-8");
...
//# sourceMappingURL=spec-route-entry.test.js.map