...
import { containsShellMetachars, isCommandAllowed, isCommandDenied, isSimpleCommand, legacyTypedReplacementWarning, } from "../../src/mcp/tools/forge-exec.js";
...
describe("forge-exec: isCommandDenied (branch coverage)", () => {
    ...
    it("denies a command with a wildcard glob", () => {
        expect(isCommandDenied("git push origin main", ["Bash(git push*)"])?.toString()).toContain("denied");
    });
...
//# sourceMappingURL=forge-security-branches.test.js.map