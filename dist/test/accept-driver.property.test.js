...
describe("aggregateVerdicts — property", () => {
    it("never throws", () => {
        fc.assert(fc.property(fc.array(artifactArb()), (artifacts) => {
...
describe("renderAcceptanceReport — property", () => {
    it("never throws", () => {
        fc.assert(fc.property(fc.string(), fc.array(artifactArb()), (topic, scenarios) => {
            const summary = aggregateVerdicts(scenarios);
            const result = { topic, scenarios, summary };
...
//# sourceMappingURL=accept-driver.property.test.js.map