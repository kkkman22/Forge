...
describe("plan: validateTopologicalOrder (branches)", () => {
    it("returns null for valid order", () => {
        expect(validateTopologicalOrder([
...
describe("state: isCompleteEntry (branches)", () => {
    it("returns true for complete entry", () => {
        expect(isCompleteEntry({ taskName: "x", tier: "standard", phase: "build", updated: "2026" })).toBe(true);
    });
    ...
    it("returns false when tier is non-string", () => {
        expect(isCompleteEntry({ taskName: "x", tier: 42, phase: "build", updated: "2026" })).toBe(false);
    });
    it("returns false for empty object", () => {
        expect(isCompleteEntry({})).toBe(false);
    });
});
//# sourceMappingURL=feature-plan-state-branches.test.js.map