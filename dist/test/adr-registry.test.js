...
import { applySupersession, findRelatedAdrs, loadAllAdrs, nextAdrId, parseAdrFrontmatter, renderAdrIndex, } from "../src/adr-registry.js";
...
describe("renderAdrIndex", () => {
    const makeEntry = (id, title, filePath) => ({
        id,
        title,
        status: "accepted",
        date: "2026-05-10",
    ...
    it("emits the generated-by header comment as the first line", () => {
        ...
        expect(out.split("\n")[0]).toBe("<!-- Generated by src/adr-registry.ts — do not edit manually -->");
    });
    ...
    it("includes all fields in each data row", () => {
        ...
        expect(out).toContain("| ADR-0001 | Adopt Zod | accepted | 2026-05-10 | .forge/decisions/ADR-0001.md |");
    });
...
//# sourceMappingURL=adr-registry.test.js.map