...
describe("recommendIsolationStrategy — properties", () => {
    it("capacity check has highest priority", () => {
        fc.assert(fc.property(fc.boolean(), fc.integer({ min: 3, max: 10 }), fc.constantFrom("light", "standard", "full"), (dirtyTree, activeWorktrees, tier) => {
            const result = recommendIsolationStrategy({
                dirtyTree,
                activeWorktrees,
                tier,
    ...
    it("always provides a non-empty reason", () => {
        fc.assert(fc.property(fc.boolean(), fc.integer({ min: 0, max: 5 }), fc.constantFrom("light", "standard", "full"), (dirtyTree, activeWorktrees, tier) => {
            const result = recommendIsolationStrategy({
                dirtyTree,
                activeWorktrees,
                tier,
    ...
    it("primary is always a valid strategy", () => {
        ...
        fc.assert(fc.property(fc.boolean(), fc.integer({ min: 0, max: 5 }), fc.constantFrom("light", "standard", "full"), fc.integer({ min: 1, max: 10 }), (dirtyTree, activeWorktrees, tier, maxConcurrent) => {
            const result = recommendIsolationStrategy({
                dirtyTree,
                activeWorktrees,
                tier,
...
//# sourceMappingURL=branch-lifecycle-isolation.property.test.js.map