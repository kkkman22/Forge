...
describe("session-id property tests", () => {
    ...
    describe("resolveSessionId", () => {
        it("always returns non-empty value for any input combination", async () => {
            ...
            fc.assert(fc.property(sessionIdArb, sessionIdArb, sessionIdArb, pidArb, (hookId, ccId, legacyId, pid) => {
        ...
        it("identical sources → consistent: true", async () => {
            const { resolveSessionId } = await import("../src/session-id.js");
            fc.assert(fc.property(fc.stringMatching(/^[a-z0-9]{4,20}$/), pidArb, (id, pid) => {
                const result = resolveSessionId({
                    hookSessionId: id,
    ...
    describe("sessionScopedKey", () => {
        it("always returns prefix-value format", async () => {
            ...
            fc.assert(fc.property(fc.stringMatching(/^[a-z]{2,10}$/), sessionIdArb, pidArb, (prefix, hookId, pid) => {
...
//# sourceMappingURL=session-id.property.test.js.map