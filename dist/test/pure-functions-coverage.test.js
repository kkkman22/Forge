...
import { buildOpenArgs, parseSnapshotJson, validatePath, validateRef, } from "../src/agent-browser-client.js";
...
describe("parseSnapshotJson — boundary cases", () => {
    it("parses the real envelope", () => {
        const snap = parseSnapshotJson(JSON.stringify({
            success: true,
            data: {
                origin: "http://x/y",
    ...
    it("throws on success:false", () => {
        expect(() => parseSnapshotJson(JSON.stringify({ success: false, error: "boom" }))).toThrow(/boom/);
    });
});
...
//# sourceMappingURL=pure-functions-coverage.test.js.map