...
describe("Integration: feature flag FORGE_STRUCTURED_FROZEN=0", () => {
    it("falls back to legacy mode", () => {
        const { exitCode } = runHook("scripts/hook-check-frozen-structured.sh", { tool_name: "Write", tool_input: { file_path: "src/main.ts" } }, { FORGE_STRUCTURED_FROZEN: "0" });
        // Legacy mode delegates to TS hook which exits 0 for non-frozen files
        expect(exitCode).toBe(0);
    });
});
//# sourceMappingURL=hook-check-frozen.integration.test.js.map