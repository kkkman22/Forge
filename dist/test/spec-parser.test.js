...
import { parseDesignMarkdown, parseRequirementsMarkdown, parseTasksMarkdown, } from "../src/spec-parser.js";
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
...
describe("PBT: parser robustness", () => {
    it("parseRequirementsMarkdown handles shuffled section order", () => {
        fc.assert(fc.property(fc.record({
            ...
            if (flags.hasGlossary)
                sections.push("## Glossary\n\n- **Term**: Def");
            sections.push(`## Requirements\n\n### Requirement 1: Test\n\n#### Acceptance Criteria\n\n- 当 X 时 系统应当 Y`);
            if (flags.hasNonFunctional)
...
`;
    ...
    it("handles adversarial repeated near-miss headings", () => {
        ...
        const nearMisses = Array.from({ length: 1000 }, (_, i) => `# Introduction ${i} extra content that is long enough to matter here`).join("\n");
        const md = `---
feature: nearmiss
status: draft
date: 2026-05-23
...
//# sourceMappingURL=spec-parser.test.js.map