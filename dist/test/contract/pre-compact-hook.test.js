...
function setupForgeEnv(opts) {
    ...
    writeFileSync(configPath, opts.configContent ??
    ...
    if (opts.lastRestatement) {
        writeFileSync(fixture(".forge", "state", "last-restatement.json"), JSON.stringify(opts.lastRestatement, null, 2));
    }
}
...
//# sourceMappingURL=pre-compact-hook.test.js.map