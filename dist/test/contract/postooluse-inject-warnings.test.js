...
describe("PostToolUse inject warnings hook (R15)", () => {
    ...
    it("injects warning for context boundary violations", () => {
        ...
        writeFileSync(fixture("src", "billing", "service.ts"), 'import { something } from "../auth/login";\n');
        const input = {
            tool_name: "Edit",
            tool_input: {
    ...
    it("injects warning when Edit touches a locked spec file", () => {
        ...
        writeFileSync(fixture(".forge", "specs", "my-feature", "spec.md"), "---\nstatus: locked\n---\n\n# My Feature Spec");
        const input = {
            tool_name: "Edit",
            tool_input: {
    ...
    it("injects warning when Write touches an approved plan file", () => {
        ...
        writeFileSync(fixture(".forge", "plans", "my-plan.md"), "---\nstatus: approved\n---\n\n# My Plan");
        const input = {
            tool_name: "Write",
            tool_input: {
...
//# sourceMappingURL=postooluse-inject-warnings.test.js.map