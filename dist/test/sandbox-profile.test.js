...
import { FORGE_LOOP_TOOLS, loadSandboxProfile, toSdkSandboxSettings, } from "../src/sandbox-profile.js";
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
function makeTmpDir() {
...
describe("toSdkSandboxSettings — property invariants", () => {
    ...
    it("always produces enabled=true regardless of profile content", () => {
        const modes = ["none", "restricted", "open"];
...
//# sourceMappingURL=sandbox-profile.test.js.map