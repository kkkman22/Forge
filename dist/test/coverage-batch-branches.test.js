...
import { extractFrontmatterStatus, getProtectionZone, hasMarkdownExtension, hasYamlFrontmatter, normalizeForgePath, } from "../src/state.js";
...
describe("evaluateMutationVerdict (all branches)", () => {
    it("returns warn when targetCount=0", () => {
        expect(evaluateMutationVerdict({ mutationScore: 0, threshold: 80, required: true, targetCount: 0 })).toBe("warn");
    });
...
//# sourceMappingURL=coverage-batch-branches.test.js.map