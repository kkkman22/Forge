...
import { buildSummary, CRITICAL_PATTERNS, matchPatterns, parseArgs, } from "../scripts/scan-recent-ci-logs.mjs";
const SAMPLE_LOG = `
...
describe("scan-recent-ci-logs", () => {
    ...
    describe("matchPatterns", () => {
        it("matches all 6 critical patterns", () => {
            const matches = matchPatterns(123, SAMPLE_LOG);
        ...
        it("includes run_id in each match", () => {
            const matches = matchPatterns(42, SAMPLE_LOG);
            for (const m of matches) {
                expect(m.run_id).toBe(42);
            }
        });
        it("includes the matching log line", () => {
            const matches = matchPatterns(1, SAMPLE_LOG);
...
//# sourceMappingURL=scan-recent-ci-logs.test.js.map