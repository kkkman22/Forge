...
describe("policy profile config", () => {
    ...
    it("parses solo, team, and enterprise profiles", () => {
        ...
        expect(parsePolicyProfileConfig("policy_profile: enterprise").policy_profile).toBe("enterprise");
    });
    it("falls back safely with a diagnostic for invalid values", () => {
        ...
        expect(warn).toHaveBeenCalledWith("policy_profile invalid in config.md (ultra); falling back to team");
        warn.mockRestore();
    });
});
//# sourceMappingURL=policy-profiles.test.js.map