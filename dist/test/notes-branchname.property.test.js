...
const iterationEntryArb = fc
    .tuple(iterationNumberArb, fc.boolean(), cleanLineArb, fc.array(cleanLineArb, { minLength: 0, maxLength: 3 }), fc.array(cleanLineArb, { minLength: 0, maxLength: 3 }))
...
const notesDocWithBranchArb = fc
