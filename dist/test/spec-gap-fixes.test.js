...
import { dispatch, writeBlockedAuditRecord, } from "../src/workflow-dispatcher.js";
let tmpRoot;
let forgeRoot;
beforeEach(() => {
...
function seedL0Eligible() {
    ...
    writeFileSync(join(tmpRoot, "workflows", "review.js"), "import { chunkedParallel } from './lib/concurrency.js';\nexport const meta = { version: '1.0.0' };\n", "utf-8");
    writeFileSync(join(tmpRoot, "workflows", "lib", "concurrency.js"), "export const chunkedParallel = () => {};\n", "utf-8");
    ...
    return {
        restoreEnv: () => {
            if (prev === undefined)
                ...
                process.env.CLAUDE_CODE_WORKFLOWS = prev;
        },
    };
}
...
describe("R12.7 — tool-health.md advisory lock concurrency", () => {
    it("concurrent appendToolHealth across 5 instances produces 5 well-formed lines", async () => {
        ...
        const degraders = Array.from({ length: 5 }, (_, i) => new RateLimitDegrader(6, toolHealthPath, `sub-${i}`));
...
//# sourceMappingURL=spec-gap-fixes.test.js.map