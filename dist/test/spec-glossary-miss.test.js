...
import { detectGlossaryMiss, renderGlossaryMissNotice, specTextFromDocument, } from "../src/spec.js";
// ---------------------------------------------------------------------------
// Fixtures
// ---------------------------------------------------------------------------
/**
...
function buildSpecWithTerms() {
    return {
        ...
        purpose: "引入 Materialization Cascade 机制，解决 Vertical Slice 难以独立交付的问题。Materialization Cascade 与 Vertical Slice 协同工作。",
        requirements: [
            {
                title: "术语一致性",
                description: "Dynamic Dispatch 的语义需对齐，Dynamic Dispatch 与 Event Sourcing 必须在 spec 与 plan 之间一致。Event Sourcing 要求持久化事件。",
                scenarios: [
...
//# sourceMappingURL=spec-glossary-miss.test.js.map