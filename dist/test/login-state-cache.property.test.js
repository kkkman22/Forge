...
import { getCachedStatePath, isStateCacheExpired, promptForManualLogin, } from "../src/login-state-cache.js";
...
describe("isStateCacheExpired — property", () => {
    it("returns boolean for any input", () => {
        fc.assert(fc.property(fc.array(fc.record({ expires: fc.option(fc.double(), { nil: undefined }) })), (cookies) => {
...
//# sourceMappingURL=login-state-cache.property.test.js.map