...
import { buildDossier, deriveTopicFromPath, detectDrifts, discoverTopics, matchStageFiles, scanStagesForTopic, } from "../src/feature-dossier.js";
...
describe("deriveTopicFromPath", () => {
    it("extracts topic from decisions with date prefix", () => {
        expect(deriveTopicFromPath("decisions/2026-04-29-structured-observability.md")).toBe("structured-observability");
    });
    it("extracts topic from decisions with ADR prefix", () => {
        expect(deriveTopicFromPath("decisions/ADR-0012-agent-skills-learnings.md")).toBe("agent-skills-learnings");
    });
    it("extracts topic from specs subdirectory", () => {
        expect(deriveTopicFromPath("specs/structured-observability/spec.md")).toBe("structured-observability");
    });
    ...
    it("handles topic with multiple hyphens", () => {
        expect(deriveTopicFromPath("plans/context-budget-management.md")).toBe("context-budget-management");
    });
...
//# sourceMappingURL=feature-dossier.test.js.map