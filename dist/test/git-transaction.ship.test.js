...
import { buildBranchDeleteCommand, buildCheckoutCommand, buildMergeAbortCommand, buildMergeCommand, buildPushCommand, validateBranchName, } from "../src/git-transaction.js";
// ---------------------------------------------------------------------------
// Generators
// ---------------------------------------------------------------------------
...
describe("Feature: ship-delivery-unification, Property 6: Force flag correctness", () => {
    it("buildBranchDeleteCommand uses -D when force=true and -d when force=false", () => {
        fc.assert(fc.property(safeBranchNameArb, fc.boolean(), (branch, force) => {
...
//# sourceMappingURL=git-transaction.ship.test.js.map