...
const INSTRUCTIONS_PATH = resolve(import.meta.dirname, "../../skills/forge/lib/resume/instructions.md");
describe("resume instructions phase coverage", () => {
    ...
    it("mentions status.md or status/ directory", () => {
        ...
        expect(hasStatusMd || hasStatusDir, "instructions must reference .forge/status.md or .forge/status/").toBe(true);
    });
    ...
    it("describes phase-specific resume behavior for review/test/ship", () => {
        ...
        expect(hasReviewContinue || hasShipContinue || content.includes("phase"), "instructions should describe how to resume from review/test/ship phases").toBe(true);
    });
});
//# sourceMappingURL=resume-phase-coverage.test.js.map