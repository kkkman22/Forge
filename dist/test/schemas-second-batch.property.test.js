...
import { PlanFileSchema, ReviewReportSchema, SpecFileSchema, safeParsePlanFile, safeParseReviewReport, safeParseSpecFile, } from "../src/schemas/index.js";
// ---------------------------------------------------------------------------
// Arbitraries
// ---------------------------------------------------------------------------
...
describe("review-report / plan-file / spec-file — round-trip", () => {
    ...
    it("PlanFileSchema round-trips any well-formed object", () => {
        fc.assert(fc.property(planFileArb, (sample) => {
            const wire = JSON.parse(JSON.stringify(sample));
    ...
    it("SpecFileSchema round-trips any well-formed object", () => {
        fc.assert(fc.property(specFileArb, (sample) => {
            const wire = JSON.parse(JSON.stringify(sample));
...
//# sourceMappingURL=schemas-second-batch.property.test.js.map