...
import { formatFrontmatter, parseAddedRemoved, parseFileCount, } from "../scripts/prepare-diff-context.mjs";
describe("prepare-diff-context: parseFileCount", () => {
    ...
    it("returns 1 for single-file stat", () => {
        const stat = "agents/spec-check.md | 51 +++++++++++++++++++++-----------------------\n 1 file changed, 28 insertions(+), 23 deletions(-)";
...
//# sourceMappingURL=prepare-diff-context.test.js.map