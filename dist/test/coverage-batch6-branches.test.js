...
import { nextPhase } from "../src/storm.js";
...
describe("zoom-out (branch coverage)", () => {
    it("buildZoomOutPrompt produces a prompt string", () => {
        const text = buildZoomOutPrompt({ topic: "test", recentWork: "did stuff" });
        expect(typeof text).toBe("string");
        expect(text.length).toBeGreaterThan(0);
    });
    it("renderZoomOut produces output", () => {
        const text = renderZoomOut({ summary: "zoomed out", actions: [] });
        expect(typeof text).toBe("string");
    });
});
...
//# sourceMappingURL=coverage-batch6-branches.test.js.map