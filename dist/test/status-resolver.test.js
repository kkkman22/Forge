...
import { isMultiTaskMode, resolveStatusPath, slugify, } from "../src/status-resolver.js";
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
...
function hasAsciiAlphanumeric(s) {
...
describe("Property 12: Task name round-trip via frontmatter", () => {
    it("slugify result can be used to create a file whose current_task recovers the original name", () => {
        ...
        fc.assert(fc.property(yamlSafeString, (taskName) => {
...
describe("resolveStatusPath", () => {
    const _makeCtx = (taskName, dirExists) => ({
        taskName,
        forgeRoot: "/project/.forge",
        dirExists,
    });
    it("resolves to status.md in single-task mode (no status/ dir)", () => {
        const ctx = { taskName: "my-feature", forgeRoot: "/project/.forge" };
    ...
    it("resolves to status/<task-id>.md in multi-task mode", () => {
        const ctx = { taskName: "User API Pagination", forgeRoot: "/project/.forge" };
...
//# sourceMappingURL=status-resolver.test.js.map