...
import { appendFileSync as mockAppendFileSync, existsSync as mockExistsSync, unlinkSync as mockUnlinkSync, } from "node:fs";
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
function makeChild(killed = false, killFn) {
    return {
        kill: vi.fn(() => killFn?.()),
        killed,
        pid: 12345,
...
//# sourceMappingURL=cleanup-chain.test.js.map