...
describe("Plugin Workflows Field (R1: workflows-integration)", () => {
    ...
    it("AC 13.1: at least one .js in workflows/ parses via esbuild --analyze", () => {
        ...
        for (const f of jsFiles) {
            const result = execFileSync("npx", ["--no-install", "esbuild", join(workflowsDir, f), "--bundle=false", "--log-level=silent"], { stdio: "pipe" });
...
//# sourceMappingURL=plugin-manifest.test.js.map