...
describe("Unit: write failure no throw", () => {
    ...
    it("dir not writable → no throw, only console.warn", async () => {
        ...
        console.warn = () => { };
        try {
            await expect(recordSkip(reviewMarkdownPath, "platform-not-bitbucket", ctx)).resolves.not.toThrow();
        }
        finally {
...
//# sourceMappingURL=skip-trace.test.js.map