...
describe("Contract: hooks if: filters", () => {
    ...
    it("hooks.json has at least 3 if: entries in PreToolUse", () => {
        ...
        const ifEntries = preToolUse.filter((e) => "if" in e);
...
//# sourceMappingURL=phase2.contract.test.js.map