...
import { commandDisable, commandEnable, commandInspect, commandList, commandNew, commandOverride, commandValidate, } from "../../src/pack/commands.js";
function makeEntry(name, categories = {}) {
    return {
        name,
...
function makeEnabled(order, entries) {
