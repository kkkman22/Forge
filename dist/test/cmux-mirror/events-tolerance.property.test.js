...
describe("events: tolerance and cursor property tests (R12.11, R14.6, R14.9)", () => {
    ...
    it("property: any sequence of lines produces valid cursor progression", async () => {
        const lineArb = fc.oneof(fc.constant('{"schema_version":1,"ts":"2026-01-01T00:00:00Z","type":"test"}'), fc.constant("NOT JSON"), fc.constant(""), fc.string({ minLength: 1, maxLength: 50 }));
        await fc.assert(fc.asyncProperty(fc.array(lineArb, { maxLength: 20 }), async (lines) => {
...
//# sourceMappingURL=events-tolerance.property.test.js.map