...
import { canParseTestOutput, classifySource, computeContextBudgetThresholds, serializeExploreResult, } from "../src/context-budget.js";
import { renderSuggestionSuffix } from "../src/rules-loader.js";
...
describe("rules-loader: renderSuggestionSuffix (branch coverage)", () => {
    it("returns empty when no lintBinding", () => {
        expect(renderSuggestionSuffix({})).toBe("");
    });
    it("renders a string lintBinding", () => {
        expect(renderSuggestionSuffix({ lintBinding: "no-console" })).toBe(" (lint: no-console)");
    });
...
//# sourceMappingURL=coverage-branches.test.js.map