...
import { buildSpawnEnv, ConcurrencyDegradationLadder, observe429, } from "../../src/concurrency-bridge.js";
let tmpRoot;
let healthPath;
beforeEach(() => {
...
describe("Integration: 3 consecutive 429 events drive the ladder end-to-end (R12.5)", () => {
    it("writes 3 tool-health records and emits matching env values for each subprocess respawn", () => {
        ...
        for (const ev of [
            ...
            if (observe429(ev)) {
                ladder.degrade();
                respawnEnvs.push(buildSpawnEnv({
                    maxParallelAgents: 6,
                    reviewConcurrency: 3,
...
//# sourceMappingURL=concurrency-bridge.test.js.map