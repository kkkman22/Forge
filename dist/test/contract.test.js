...
describe("CE-Inspired Review Enhancement - Phase 1", () => {
    ...
    it("forge-learn SKILL has dual-track templates", () => {
        const content = readFileSync(resolve(__dirname, "..", "skills/forge/lib/learn/instructions.md"), "utf-8");
...
describe("CE-Inspired Review Enhancement - Phase 3", () => {
    ...
    it("review skill has new CLI parameters", () => {
        const content = readFileSync(resolve(__dirname, "..", "skills/forge/lib/review/instructions.md"), "utf-8");
