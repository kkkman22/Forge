...
import { handoffPath, isValidTransition, parseHandoff, priorHandoffPaths, renderHandoff, STAGE_TRANSITIONS, validateHandoffEntry, } from "../src/handoff.js";
// ---------------------------------------------------------------------------
// Generators
// ---------------------------------------------------------------------------
...
const handoffEntryArb = fc.record({
...
const stageArb = fc.constantFrom("decide", "spec", "plan", "build", "review", "test", "ship", "learn");
...
describe("Property 33: Handoff validation", () => {
    it("valid entry with at least one decision passes", () => {
        fc.assert(fc.property(handoffEntryArb, (entry) => {
...
describe("Property 34: Stage transitions", () => {
    ...
    it("self-transitions are invalid", () => {
        fc.assert(fc.property(stageArb, (stage) => {
...
describe("Property 35: Render/parse round-trip", () => {
    it("renderHandoff → parseHandoff preserves all fields", () => {
        fc.assert(fc.property(transitionArb, handoffEntryArb, ([from, to], entry) => {
            const doc = {
                fromStage: from,
                toStage: to,
...
//# sourceMappingURL=handoff.property.test.js.map