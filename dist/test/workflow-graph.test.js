...
describe("workflow graph DSL", () => {
    ...
    it("encodes profile-specific gate requirements without changing default team behavior", () => {
        expect(getPolicyGateRequirements("solo", "ship")).toEqual(expect.objectContaining({ review: "basic", test: "required", mutation: "optional" }));
        expect(getPolicyGateRequirements("team", "ship")).toEqual(expect.objectContaining({ review: "required", test: "required", mutation: "optional" }));
        expect(getPolicyGateRequirements("enterprise", "ship")).toEqual(expect.objectContaining({
            review: "full",
            test: "required",
