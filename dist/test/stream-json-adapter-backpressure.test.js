...
import { BackpressureUnrelievedError, LineTooLargeError, StreamJsonAdapter, } from "../src/stream-json-adapter.js";
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
const MiB = 1024 * 1024;
...
describe("StreamJsonAdapter backpressure", () => {
    ...
    it("AC3.4: throws LineTooLargeError for a line >64 MiB", async () => {
        ...
        try {
            ...
            expect(err.lineLength).toBeGreaterThan(64 * MiB);
            expect(err.message).toContain("64 MiB");
        }
    });
    // -----------------------------------------------------------------------
...
//# sourceMappingURL=stream-json-adapter-backpressure.test.js.map