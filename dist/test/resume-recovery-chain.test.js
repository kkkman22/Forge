...
import { RECOVERY_CHAIN_STEPS, runRecoveryChain } from "../src/resume.js";
// Git log lines are separator (\x00) delimited: hash \x00 message \x00 timestamp.
const SEP = "\x00";
function gitLine(hash, message, timestamp) {
...
//# sourceMappingURL=resume-recovery-chain.test.js.map