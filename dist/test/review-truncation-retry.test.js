...
vi.mock("../src/review-final-block.js", () => ({
    enforceFinalReportContract: (r) => r,
...
<!-- review-final -->`;
function makeSuccessResult(agentType, output) {
    return { agentType, status: "success", output };
}
function makeInvocations() {
    return [
...
describe("runReviewWithTruncationHandling", () => {
    ...
    it("serial retry uses concurrency=1", async () => {
        ...
        let callCount = 0;
        mockedRunner.mockImplementation((_invs, _exec, concurrency) => {
...
//# sourceMappingURL=review-truncation-retry.test.js.map