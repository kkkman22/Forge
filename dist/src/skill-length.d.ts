 ...
 */
export declare const DEFAULT_LIMIT = 150;
/**
 ...
 * Pure; no IO.
 */
export declare function countEffectiveLines(content: string): number;
/**
 ...
 * Pure; no IO.
 */
export declare function checkSkillLength(filePath: string, content: string, limit?: number): SkillLengthCheck;
/**
 ...
 */
export declare function validateAllSkillLengths(fs: SkillLengthFs, skillsDir: string, limit?: number): SkillLengthCheck[];
