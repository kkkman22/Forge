 ...
 */
export function checkRootWhitelist(rootDir, whitelist) {
    const diagnostics = [];
    let entries;
    try {
    ...
    if (hasLicense && hasLicenseMd) {
        diagnostics.push({
            ...
            severity: "critical",
            file: "LICENSE.md",
            message: "Both LICENSE and LICENSE.md exist in root. Only one is allowed — remove one to resolve ambiguity.",
...
//# sourceMappingURL=root-whitelist.js.map