...
export declare const EXCLUDED_PREFIXES: readonly ["apps/", "dist/", "dist-plugin/", "node_modules/", ".git/", "test-results/", "apps/forge-loop-desktop/src-tauri/target/", ".claude/worktrees/"];
