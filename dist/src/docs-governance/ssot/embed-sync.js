 ...
 */
export function syncEmbeds(fileContent, filePath, registry, ssotData) {
    ...
    const structuralErrors = parseDiags.filter((d) => d.severity === "error" &&
...
//# sourceMappingURL=embed-sync.js.map