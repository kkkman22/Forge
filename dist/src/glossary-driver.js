 ...
 */
export function ensureGlossaryExists(fs, options = {}) {
 ...
 */
function buildInitialGlossary(now) {
    const isoDate = toIsoDate(now);
    const terms = INITIAL_GLOSSARY_TERMS.map((t) => ({
        ...t,
