 ...
 */
export function buildGoalCondition(tier) {
    switch (tier) {
        case "light":
            return null;
        case "standard":
 ...
 */
export async function setGoal(condition) {
 ...
 */
export async function shouldClearGoal(stateRoot) {
...
//# sourceMappingURL=goal-integration.js.map