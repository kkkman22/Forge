...
import { buildAddAllCommand, buildBranchDeleteCommand, buildCheckoutCommand, buildCleanCommand, buildCleanDryRunCommand, buildCommitCommand, buildMergeAbortCommand, buildMergeCommand, buildPushCommand, buildResetCommand, buildStashCommand, buildStashRefCommand, } from "./git-transaction.js";
...
export class EffectExecutor {
    ...
    executeShipPushPr(remote, branch, title, body) {
        ...
        try {
            ...
            this.deps.onLog(`⚠️ PR creation failed: ${prError instanceof Error ? prError.message : String(prError)}. Branch was pushed successfully.`);
        }
    }
    /**
     ...
     */
    async executeWriteEventLog(entry) {
        try {
