...
describe("computeDependencyClosure", () => {
    ...
    it("closure only contains task and its transitive deps", () => {
        fc.assert(fc.property(fc.array(fc.nat({ max: 20 }), { minLength: 1, maxLength: 10 }).map((nums) => {
            const unique = [...new Set(nums)];
            return unique.map((n, i) => makeTask(`T-${String(n).padStart(2, "0")}`, i > 0 ? [`T-${String(unique[i - 1]).padStart(2, "0")}`] : undefined));
        }), (tasks) => {
...
//# sourceMappingURL=spec-wave.test.js.map