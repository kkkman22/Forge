...
describe("reader: reads .forge/ state (R2.1, R2.2)", () => {
    ...
    it("reads progress from progress file (R3.2)", () => {
        ...
        mkdirSync(join(forgeDir, "progress"), { recursive: true });
        writeFileSync(join(forgeDir, "progress", "user-pagination.md"), [
            "---",
    ...
    it("reads review state (R4.2)", () => {
        ...
        mkdirSync(join(forgeDir, "reviews"), { recursive: true });
        writeFileSync(join(forgeDir, "reviews", "user-pagination.md"), [
            "---",
            "layers_status:",
            "  spec_check: done",
...
describe("reader-emitter roundtrip (R2.1, R2.2)", () => {
    ...
    it("full roundtrip: .forge/ → state → commands", () => {
        ...
        writeFileSync(join(forgeDir, "progress", "task-1.md"), [
            "---",
            'topic: "task-1"',
            "---",
            "",
...
//# sourceMappingURL=reader-emitter-roundtrip.test.js.map