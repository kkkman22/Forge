...
describe("budget: monotonic non-increasing property (R12.2, R7.3)", () => {
    it("available budget never increases within a session for any consume sequence", () => {
        fc.assert(fc.property(fc.record({ initial: fc.integer({ min: 0, max: 50 }) }), fc.array(fc.boolean(), { maxLength: 20 }), ({ initial }, consumeSequence) => {
...
//# sourceMappingURL=budget-monotonic.property.test.js.map