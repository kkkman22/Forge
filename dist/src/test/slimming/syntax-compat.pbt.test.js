...
describe("Property 5: Syntax Backward Compatibility", () => {
    it("all pre-slimming subcommands are still valid", () => {
        fc.assert(fc.property(fc.constantFrom(...SUBCOMMANDS), (cmd) => {
    ...
    it("review output schema is backward compatible", () => {
        ...
        fc.assert(fc.property(fc.record({
            ...
            merged_summary: fc.option(fc.record({ P0_blockers: fc.nat(), P1: fc.nat(), P2: fc.nat() })),
        }), (review) => {
...
//# sourceMappingURL=syntax-compat.pbt.test.js.map