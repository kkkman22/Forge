...
const distPluginInstructionsPath = join(projectRoot, "dist-plugin/skills/forge/lib/review/instructions.md");
describe("Hard-gate presence", () => {
    ...
    it("dist-plugin mirror has identical Hard-gate content", () => {
        ...
        const extractHardGateSection = (content) => {
...
//# sourceMappingURL=hard-gate-presence.test.js.map