...
import { determineVerificationStrategy, INCREMENTAL_THRESHOLD, } from "../src/incremental-verifier.js";
describe("Feature: forge-review-fix-optimization, Property 20: Verification strategy threshold", () => {
    it("<50 lines → incremental, >=50 lines → targeted-review", () => {
        fc.assert(fc.property(fc.integer({ min: 0, max: 10000 }), (linesChanged) => {
...
//# sourceMappingURL=incremental-verifier.property.test.js.map