...
import { generateLivingDoc, parseAcceptanceVerdicts, parseSpecScenarios, } from "../../src/living-doc/generator.js";
// ---------------------------------------------------------------------------
// parseSpecScenarios
// ---------------------------------------------------------------------------
...
describe("generateLivingDoc", () => {
    ...
    it("groups scenarios by context from a single spec", () => {
        fs.writeFileSync(path.join(specsDir, "order.md"), `---
context: OrderManagement
---
# Order Spec
...
### Cancel order
`);
        fs.writeFileSync(path.join(acceptanceDir, "order-acceptance.md"), `# Acceptance
...
`);
        ...
        fs.writeFileSync(path.join(acceptanceDir, "report.md"), `# Acceptance
...
`);
    ...
    it("reads scenarios from three-file layout (requirements.md in topic dir)", () => {
        ...
        fs.writeFileSync(path.join(topicDir, "requirements.md"), `---
context: AuthContext
