...
describe("checkVersionCompatibility", () => {
    ...
    it("handles caret range", () => {
        expect(checkVersionCompatibility({ ...validManifest, forgeVersion: "^2.0.0" }, "2.5.0")).toBe(true);
    });
    it("handles tilde range", () => {
        expect(checkVersionCompatibility({ ...validManifest, forgeVersion: "~2.0.0" }, "2.0.5")).toBe(true);
    });
});
//# sourceMappingURL=skill-validator.test.js.map