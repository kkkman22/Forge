...
describe("resolveFileContext with JSDoc", () => {
    it("JSDoc @context overrides glob", () => {
        const ctx = resolveFileContext("src/domain/folio/other.ts", { "src/domain/folio/**": "folio-billing" }, "legacy-billing");
        expect(ctx).toBe("legacy-billing");
    });
    it("glob matches when no JSDoc", () => {
        const ctx = resolveFileContext("src/domain/folio/service.ts", { "src/domain/folio/**": "folio-billing" }, null);
...
//# sourceMappingURL=ownership-real.test.js.map