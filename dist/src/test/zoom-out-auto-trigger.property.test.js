...
import { formatAutoZoomOutInjection, shouldAutoTriggerZoomOut, } from "../src/zoom-out.js";
// ---------------------------------------------------------------------------
...
describe("shouldAutoTriggerZoomOut", () => {
    ...
    it("property: alreadyTriggered=true always returns shouldTrigger=false", () => {
        fc.assert(fc.property(fc.constantFrom("debug", "decide"), fc.integer({ min: 0, max: 10 }), fc.boolean(), (scenario, rounds, consensus) => {
            const ctx = {
                scenario,
                alreadyTriggered: true,
                ...(scenario === "debug"
    ...
    it("is deterministic: same input → same output", () => {
        fc.assert(fc.property(fc.record({
            scenario: fc.constantFrom("debug", "decide"),
...
describe("formatAutoZoomOutInjection", () => {
    ...
    it("property: always contains the three section headings", () => {
        ...
        }), fc.constantFrom("debug", "decide"), (output, scenario) => {
...
//# sourceMappingURL=zoom-out-auto-trigger.property.test.js.map