...
describe("fetchPRMetadata", () => {
    ...
    it("uses gh for github host", async () => {
        ...
        const result = await resumeModule.fetchPRMetadata({ host: "github", number: 1, url: "https://github.com/org/repo/pull/1" }, { exec: execMock });
    ...
    it("returns fetcherUsed='none' on timeout", async () => {
        ...
        const result = await resumeModule.fetchPRMetadata({ host: "github", number: 1, url: null }, { exec: execMock, timeout: 100 });
        expect(result.fetcherUsed).toBe("none");
...
//# sourceMappingURL=resume-from-pr.test.js.map