 ...
 */
function buildPuaConfig(opts) {
    const puaEnabled = opts?.pua === true;
    const rawPuaTaskType = opts?.puaTaskType;
    const puaTaskType = rawPuaTaskType && VALID_PUA_TASK_TYPES.has(rawPuaTaskType)
        ? rawPuaTaskType
        : puaEnabled
            ? "general"
            : undefined;
...
//# sourceMappingURL=pua-cli.test.js.map