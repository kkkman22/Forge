...
import { compareExpectedOutput } from "../../src/build.js";
describe("compareExpectedOutput", () => {
    ...
    it("fails exit 1 expectation with exit 0 actual", () => {
        const spec = { expected: "exit 1", actual: { exitCode: 0, output: "passed" } };
        const result = compareExpectedOutput(spec);
...
//# sourceMappingURL=expected-comparison.test.js.map