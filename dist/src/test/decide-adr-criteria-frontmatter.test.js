...
import { parseAdrFrontmatter } from "../src/adr-registry.js";
import { finalizeAdr, renderAdrFileContent } from "../src/decide.js";
// ---------------------------------------------------------------------------
...
describe("renderAdrFileContent — ADR criteria fields", () => {
    ...
    it("emits reversibility when set to 'hard'", () => {
        const entry = { ...baseEntry, reversibility: "hard" };
    ...
    it("omits trade_off_alternatives when provided as an empty array", () => {
        const entry = { ...baseEntry, trade_off_alternatives: [] };
        const rendered = renderAdrFileContent(entry, "");
        expect(rendered).not.toContain("trade_off_alternatives:");
    });
...
//# sourceMappingURL=decide-adr-criteria-frontmatter.test.js.map