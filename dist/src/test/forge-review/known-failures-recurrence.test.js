...
function makeDiff(files = [], changedText = "") {
...
describe("known-failures — recurrence", () => {
    ...
    it("returns empty when no failures match diff patterns", () => {
        const failures = [makeFailure({ signature: "unused import in module X" })];
...
//# sourceMappingURL=known-failures-recurrence.test.js.map