...
`;
        ...
        expect(rules[0].patterns[0].fix_suggestion).toBe("改用 Money: const amount: Money = Money.of(100, 'CNY')");
...
`;
        writeFixture("lint-rules/manifest.yaml", manifestContent);
        writeFixture("lint-rules/rules/a.yaml", `
id: rule-a
severity: error
description: "Rule A"
target_globs:
...
`);
        writeFixture("lint-rules/rules/b.yaml", `
id: rule-b
severity: warn
description: "Rule B"
target_globs:
...
//# sourceMappingURL=pack-rules.test.js.map