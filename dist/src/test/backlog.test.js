...
import { appendToBacklog, findOverlappingEntries, generateBacklogHeader, parseBacklog, resolveEntry, serializeBacklog, } from "../src/backlog.js";
// ---------------------------------------------------------------------------
// Header generation
// ---------------------------------------------------------------------------
...
// Helpers
// ---------------------------------------------------------------------------
function makeEntry(id, filePath) {
    return {
        id,
        severity: "P2",
        filePath,
