...
describe("Bitbucket MCP adapter degradation [R14.1, R14.2]", () => {
    ...
    it("does not throw on any error", async () => {
        ...
        await expect(tryFetchEnrichment("any-topic", { connectionTimeout: 1, responseTimeout: 1 })).resolves.toBeNull();
        await expect(postPRComment("any-topic", "comment", { connectionTimeout: 1, responseTimeout: 1 })).resolves.toBe(false);
    });
});
//# sourceMappingURL=canvas-bitbucket-degradation.test.js.map