...
import { findTerm, mergeTerm, parseGlossary, renderGlossary, } from "../src/glossary.js";
import { buildNewGlossaryTerm, extractSessionTermCandidates, } from "../src/learn.js";
// ---------------------------------------------------------------------------
// Fixtures
// ---------------------------------------------------------------------------
function buildEmptyGlossary() {
    return { schema_version: 1, updated: "2026-05-05", terms: [] };
}
function buildSeededGlossary() {
    return {
        schema_version: 1,
        updated: "2026-05-05",
        terms: [
...
describe("buildNewGlossaryTerm", () => {
    ...
    it("stores the session filename when provided", () => {
        const term = buildNewGlossaryTerm({ term: "Vertical Slice", context: "可独立交付的最小功能切片", frequency: 2 }, fixedNow, "2026-05-05-glossary-writeback.md");
    ...
    it("omits source_session when the filename is absent or blank", () => {
        const a = buildNewGlossaryTerm({ term: "Vertical Slice", context: "context line", frequency: 2 }, fixedNow);
        const b = buildNewGlossaryTerm({ term: "Vertical Slice", context: "context line", frequency: 2 }, fixedNow, "   ");
    ...
    it("caps the definition at 200 characters", () => {
        ...
        const term = buildNewGlossaryTerm({ term: "长术语", context: longContext, frequency: 2 }, fixedNow);
        expect(term.definition.length).toBeLessThanOrEqual(200);
    });
});
// ---------------------------------------------------------------------------
...
describe("glossary writeback end-to-end", () => {
    ...
    it("session with new terms → glossary contains them after mergeTerm('append')", () => {
        ...
        const newTerm = findTerm(updated, "Materialization Cascade");
...
//# sourceMappingURL=learn-glossary-writeback.test.js.map