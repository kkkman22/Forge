...
describe("spec.ts leak integration", () => {
    it("re-exports detectSpecLeak from spec-leak-detector", () => {
        const findings = detectSpecLeak("## Proposed Change\n\nCreate a class UserService for auth.\n", ".forge/specs/user-auth/spec.md", bannedRegistry, emptyGlossary, "user-auth");
    ...
    it("detectSpecLeak returns empty for clean spec text", () => {
        const findings = detectSpecLeak("## Requirements\n\nWhen user submits form, show success message.\n", ".forge/specs/form/spec.md", bannedRegistry, emptyGlossary, "form");
        expect(findings).toEqual([]);
    });
});
//# sourceMappingURL=leak-integration.test.js.map