...
export type GateSkipReason = "platform-disabled-by-config" | "platform-not-bitbucket" | "mcp-not-configured" | "override-but-mcp-missing" | "mcp-base-url-mismatch";
...
export type PostFailureReason = GateSkipReason | "disabled-by-cli" | "review-markdown-not-found" | "parse-error";
