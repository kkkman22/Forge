 ...
 */
export function isBitbucketUrl(url) {
    if (!url)
        return false;
    try {
 ...
 */
export function selectRemoteUrl(remotes, mcpBaseUrl) {
    if (!remotes.length)
        return null;
 ...
 */
export function checkPlatformGate(input) {
...
//# sourceMappingURL=platform-gate.js.map