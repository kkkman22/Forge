 ...
 */
import { applyFailure, applySuccess, calculateBackoffMs, shouldCircuitBreak, } from "./failure-handler.js";
// ---------------------------------------------------------------------------
// Initial state
// ---------------------------------------------------------------------------
/**
 ...
 */
export function shouldAbort(state, limits) {
 ...
 */
export function formatCommitMessage(iteration, summary) {
 ...
 */
function addTokenUsage(state, usage) {
    return {
        ...state,
...
export function transition(state, event, limits = {}) {
    ...
    switch (event.type) {
        ...
        case "iteration_success": {
            ...
            const effects = [{ type: "commit", message: commitMessage }];
        ...
        default: {
            ...
            throw new Error(`Unhandled orchestrator event type: ${_exhaustive.type}`);
        }
    }
}
