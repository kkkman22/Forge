...
// ---------------------------------------------------------------------------
export function parseExplicitScenarios(specContent) {
    const scenarios = [];
...
// Unified Entry
// ---------------------------------------------------------------------------
export function parseScenariosFromSpec(specContent) {
...
export function selectScenariosForRun(scenarios, options) {
    ...
    pool.sort((a, b) => {
        const tagPriority = (s) => {
            if (s.tags.includes("@critical"))
                return 0;
            if (s.tags.includes("@happy-path"))
                return 1;
            return 2;
        };
...
export function classifyScenarioType(scenario) {
