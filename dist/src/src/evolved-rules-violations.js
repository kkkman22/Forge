 ...
 */
export function scanForTriggers(text, sessionDate, signals = DEFAULT_SIGNALS) {
    ...
    for (const signal of signals) {
        ...
        if (signal.type === "violation")
            current.violations += matches.length;
        else
            current.guards += matches.length;
 ...
 */
export function applyTriggerUpdates(body, report) {
...
//# sourceMappingURL=evolved-rules-violations.js.map