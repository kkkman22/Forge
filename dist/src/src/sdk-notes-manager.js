 ...
 */
export function buildIterationEntry(number, success, output) {
    return {
        number,
        success,
        summary: output.summary,
 ...
 */
export function appendAndPersistNotes(notesDocument, notesContent, entry, notesPath, usage, logger, orchestratorState, t, runId) {
 ...
 */
export function logTokenUsage(usage, orchestratorState, logger, runId, t) {
    ...
    logger.log(createLogEntry("token_usage", "info", message, {
        runId,
...
//# sourceMappingURL=sdk-notes-manager.js.map