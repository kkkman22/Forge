...
export type PackExtendsCategory = "contexts" | "glossary" | "scenarios" | "state_machines" | "banned_patterns" | "lint_rules" | "templates" | "agents" | "utils";
...
export type ContextMapType = "partnership" | "customer-supplier" | "conformist" | "acl" | "open-host" | "published-language" | "shared-kernel";
