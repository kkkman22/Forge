 ...
 */
export declare function buildSkillCandidates(skillName: string, locale: string, defaultLocale: string): string[];
/**
 ...
 */
export declare function resolveSkillFile(candidates: string[], existsCheck: (path: string) => boolean): SkillResolution;
/**
 ...
 */
export declare function validateSkillName(frontmatterName: string, directoryName: string): boolean;
