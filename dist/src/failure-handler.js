 ...
 */
export function createInitialFailureState() {
    return {
 ...
 */
export function applyFailure(state, kind) {
    if (kind === "soft") {
        return {
 ...
 */
export function applySuccess(_state) {
    return {
        consecutiveFailures: 0,
        consecutiveErrors: 0,
    };
 ...
 */
export function calculateBackoffMs(consecutiveErrors, baseMs = DEFAULT_BASE_MS) {
 ...
 */
export function shouldCircuitBreak(consecutiveFailures, threshold = DEFAULT_CIRCUIT_BREAKER_THRESHOLD) {
