...
export class RateLimitDegrader {
    ...
    degradationCount = 0;
    currentLimit;
    constructor(initialLimit, toolHealthPath, subcommand) {
        this.initialLimit = initialLimit;
        this.toolHealthPath = toolHealthPath;
    ...
    // -------------------------------------------------------------------------
    appendToolHealth(oldLimit, newLimit) {
...
//# sourceMappingURL=rate-limit-degrader.js.map