...
const DEFAULT_SEQUENCE = SKILL_COMMAND_SEQUENCES.standard;
// ---------------------------------------------------------------------------
// Public API
// ---------------------------------------------------------------------------
/**
 ...
 */
export function determineNextSkill(input) {
...
const COMMITABLE_PHASES = new Set(["build", "plan", "fix", "refactor-apply", "fix-apply"]);
/**
 ...
 */
export function shouldCommitForPhase(phase, success) {
    if (!success)
        return false;
    return COMMITABLE_PHASES.has(phase);
}
//# sourceMappingURL=skill-scheduler.js.map