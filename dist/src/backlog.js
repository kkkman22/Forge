...
export function generateBacklogHeader() {
    return `---
title: "Forge Backlog"
...
export function serializeBacklog(entries) {
 ...
 * @internal
 */
export function appendToBacklog(existing, newFindings) {
 ...
 * @internal
 */
export function findOverlappingEntries(entries, affectedFiles) {
 ...
 * @internal
 */
export function resolveEntry(entries, entryId, resolvedBy, resolvedDate) {
