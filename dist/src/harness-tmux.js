...
export function runTmuxHarness(opts) {
    try {
        ...
        // Capture pane output
        const captureResult = spawnSync("tmux", ["capture-pane", "-t", sessionId, "-p", "-S", "-1000"], { encoding: "utf-8", timeout: 5000 });
        cleanupSession(sessionId);
...
//# sourceMappingURL=harness-tmux.js.map