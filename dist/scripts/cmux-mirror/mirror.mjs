 ...
 */
export async function createMirrorDaemon({ forgeDir = ".forge", socketDir = "/tmp", cmuxAvailable: isAvailable = cmuxAvailable(), forcePolling = false, pollIntervalMs = DEFAULT_POLL_MS, } = {}) {
