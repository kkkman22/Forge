...
async function main(argv) {
    ...
    if (!head) {
        process.stderr.write("ERROR: cannot resolve HEAD (not a git repo, or git unavailable)\n");
        process.exit(1);
    }
    ...
    const rawDiff = tryExec(`git diff ${base}...HEAD -- ${excludeArgs}`) || "";
...
//# sourceMappingURL=prepare-diff-context.mjs.map