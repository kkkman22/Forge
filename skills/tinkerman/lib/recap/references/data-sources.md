...
`.tinkerman/knowledge/sessions/` — per-session NDJSON with timestamps, topics, outcomes.

## Task Progress

`.tinkerman/progress/` — per-task markdown with status, phase, completion timestamps.
