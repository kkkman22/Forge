---
name: forge-grill
description: "Socratic grilling loop driving one-question-at-a-time decision tree resolution. Use when user starts full-tier task / says 'grill me' / replies 'dig deeper' during decide phase / before locking an ambiguous spec."
