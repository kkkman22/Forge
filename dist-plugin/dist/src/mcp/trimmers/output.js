 ...
 * failure handling.
 */
function formatFailureOutput(stdout, stderr) {
 ...
 */
async function rtkCompress(_stdout) {
 ...
 * @returns Trimmed or full output string
 */
export async function trimWithFallback(stdout, stderr, exitCode, rtkAvailable) {
