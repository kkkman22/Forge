...
| 触发源 | 含义 |
|--------|------|
| `手动` | 用户主动运行 `/forge charter update` |
| `spec 触发` | 下游 skill（decide/spec/plan）检测到 charter drift 后触发更新 |
| `check 触发` | `/forge charter check` 发现违规后触发更新 |
