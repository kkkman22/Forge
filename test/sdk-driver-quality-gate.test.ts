/**
 * Unit tests for quality gate integration in SdkDriver (skill-aware mode).
 *
 * Verifies that the SdkDriver correctly evaluates quality gates after
 * skill phase completion and updates internal state accordingly:
 * - Review gate blocked → increments reviewFixAttempts
 * - Review gate passed → resets reviewFixAttempts to 0
 * - Test gate blocked → marks iteration as soft failure
 * - Ship gate blocked → aborts ship and marks soft failure
 *
