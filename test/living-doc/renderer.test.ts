...
import type { LivingDocContext, LivingDocData } from "../../src/living-doc/generator.js";
import {
  escapeHtml,
  renderContextPage,
  renderIndexPage,
  renderLivingDoc,
} from "../../src/living-doc/renderer.js";

// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------

function makeContext(overrides?: Partial<LivingDocContext>): LivingDocContext {
  return {
    name: "Order",
    specs: [
      {
...
function makeData(contexts?: Map<string, LivingDocContext>): LivingDocData {
