...
describe("renderCatalog", () => {
  ...
  it("renders a minimal catalog for empty knowledge base", () => {
    const input: CatalogInput = { generatedAt: baseDate };
  ...
  it("renders top solutions sorted by confidence", () => {
    ...
    const input: CatalogInput = { generatedAt: baseDate, solutions };
    const output = renderCatalog(input);
  ...
  it("truncates solutions beyond 5", () => {
    const solutions: SolutionSummary[] = Array.from({ length: 8 }, (_, i) => ({
  ...
  it("renders instinct patterns grouped by tag", () => {
    ...
    const input: CatalogInput = { generatedAt: baseDate, patterns };
    const output = renderCatalog(input);
  ...
  it("stays under 60 lines", () => {
    ...
    const solutions: SolutionSummary[] = Array.from({ length: 15 }, (_, i) => ({
      topic: `sol-${String(i)}`,
