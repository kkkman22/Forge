...
const pressureLevelArb: fc.Arbitrary<PressureLevel> = fc.constantFrom(
  "L0" as const,
  "L1" as const,
  "L2" as const,
  "L3" as const,
 ...
 */
const puaStatusFieldsArb: fc.Arbitrary<PuaStatusFields> = fc.record({
...
describe("Feature: pua-quality-engine, Property 11: PUA StatusFile 字段 round-trip", () => {
  ...
  it("writePuaFields then extractPuaFields returns semantically equivalent fields", () => {
    fc.assert(
      fc.property(statusFileArb, puaStatusFieldsArb, (content, fields) => {
...
describe("Feature: pua-quality-engine, Property 12: PUA StatusFile 字段清除完整性", () => {
  ...
  it("clearPuaFields then extractPuaFields returns all fields as undefined", () => {
    fc.assert(
      fc.property(statusFileWithPuaFieldsArb, (contentWithFields) => {
