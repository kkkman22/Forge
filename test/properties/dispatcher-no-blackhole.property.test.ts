    ...
    await fc.assert(
      fc.asyncProperty(
        fc.record({
          ...
          l0ErrorMessage: fc.oneof(
            fc.constant("bp() exception"),
            fc.constant("schema validation failed"),
            fc.constant("subprocess crash"),
            fc.constant("stuck timeout exceeded"),
            fc.constant("FrozenZoneViolation"),
