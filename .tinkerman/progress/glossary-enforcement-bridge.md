...
> Spec: `.tinkerman/specs/glossary-enforcement-bridge/` (locked, 5 REQ, 5 INV)
> Branch: `feat/glossary-enforcement-sliceC`
> 来源: slice B `.tinkerman/specs/domain-knowledge-threading/requirements.md` REQ-6 (deferred)
...
（只读摘要），但 **enforcement 仍只读扁平 `.tinkerman/glossary.md`**——pack 里定义的术语不参与冲突检测。
