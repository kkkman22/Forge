...
> 来源：`.tinkerman/spec-audit-report.md`（2026-06-03）+ 2026-06-07 主 Agent 代码复核
...
- `.tinkerman/specs/partial-spec-backlog-remediation/requirements.md`
- `.tinkerman/specs/partial-spec-backlog-remediation/design.md`
- `.tinkerman/specs/partial-spec-backlog-remediation/tasks.md`
