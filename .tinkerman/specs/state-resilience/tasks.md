...
layout: tasks
created: 2026-05-01
spec_ref: ".tinkerman/specs/state-resilience/requirements.md"
---
...
- [x] 8.4 Manually test: delete `.tinkerman/status.md`, run `/forge resume`, verify reconstruction works *(covered by `test/resume-recovery.test.ts` integration tests)*
