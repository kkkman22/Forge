...
layout: tasks
created: 2026-04-29
spec_ref: ".tinkerman/specs/forge-review-fix-optimization/requirements.md"
---
...
- [x] 12. Update SKILL documents
  - [x] 12.1 Add CI command section to `skills/forge-build/SKILL.md`
    - Add "CI 验证命令" section instructing AI to read `ci_check_command` from `.tinkerman/config.md`
