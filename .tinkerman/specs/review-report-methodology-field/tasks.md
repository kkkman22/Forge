...
layout: tasks
created: 2026-05-17
spec_ref: ".tinkerman/specs/review-report-methodology-field/requirements.md"
---
...
- [x] 3. RED — legacy parser 测试
  ...
  - 测试用例：
    - `legacy path fills methodology default for old reports without field` (fixture: `.tinkerman/reviews/atomic-task-depends-on-utilization.md`)
