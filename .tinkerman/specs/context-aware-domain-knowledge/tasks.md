...
layout: tasks
created: 2026-06-03
spec_ref: ".tinkerman/specs/context-aware-domain-knowledge/requirements.md"
---
...
- [ ] 1.1 在 `.tinkerman/glossary.md` 的 frontmatter（`---` 块）中，确认 `schema_version` 字段存在。将 `schema_version` 从 `1` 升级为 `2`。
