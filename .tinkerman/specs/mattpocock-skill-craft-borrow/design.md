...
- `.tinkerman/knowledge/out-of-scope/`(新目录约定):R3。
- `.tinkerman/specs/mattpocock-skill-craft-borrow/agents-md-noop-audit.md`(附件):R7 体检清单。
...
- **Rollback Checklist**:
  ...
  - 移除目录约定:`.tinkerman/knowledge/out-of-scope/`(若已创建)。
