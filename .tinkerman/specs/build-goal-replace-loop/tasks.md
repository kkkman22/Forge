...
layout: tasks
created: 2026-05-30
spec_ref: ".tinkerman/specs/build-goal-replace-loop/requirements.md"
---
...
- [ ] 3.1 在 `.tinkerman/config.md` 新增 `build.use_goal: true`
- [ ] 3.2 更新 `forge init` 模板（`templates/` 中的 config.md 模板）
- [ ] 3.3 添加注释说明 `use_goal` 的作用

**Verify-By**: bash — `grep 'use_goal' .tinkerman/config.md`
**关联需求**: R3
