...
layout: tasks
created: 2026-05-30
spec_ref: ".tinkerman/specs/configchange-hook/requirements.md"
---
...
**Verify-By**: bash — JSON 校验通过 + 手动修改 `.tinkerman/config.md` 触发提示
**关联需求**: R2

## Task 3: 验证与回归测试

- [ ] 3.1 `npm run check` 通过
- [ ] 3.2 手动修改 `.tinkerman/config.md`，确认 Claude Code 输出 `additionalContext` 提示
