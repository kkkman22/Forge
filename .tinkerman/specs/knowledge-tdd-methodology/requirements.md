...
3. THE 章节 SHALL 将验证结果记录到 `.tinkerman/knowledge/skill-feedback.md`。
...
1. `.tinkerman/knowledge/evolved-rules.md` 的 rule 格式 SHALL 追加两个可选字段：`Verified_via` 和 `Baseline_violation`。
