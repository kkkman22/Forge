...
grep -nE '(TBD|TODO|待确认|待补|后续补充|implement later|fill in)' .tinkerman/specs/<topic>/tasks.md
grep -nE '(适当|appropriate|合理|properly)' .tinkerman/specs/<topic>/tasks.md
grep -nE '(参考 Task|类似 Task|同 Task|similar to Task)' .tinkerman/specs/<topic>/tasks.md
grep -nE '编写测试|write tests|add tests' .tinkerman/specs/<topic>/tasks.md
