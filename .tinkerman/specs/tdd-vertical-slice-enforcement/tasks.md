...
layout: tasks
created: 2026-06-03
spec_ref: ".tinkerman/specs/tdd-vertical-slice-enforcement/requirements.md"
---
...
- [ ] 4.1 验证 CLAUDE.md §2.1.1 引用了 `.tinkerman/glossary.md` 的 `Vertical Slice` 定义。验证 `tdd-rules.md` §5/§6 的示例代码语法正确。验证 `atomic-task-format.md` 的 Constraint 不与现有 Expected 字段规则冲突。
