...
work_nature: feature
brownfield: true
import_source: ".tinkerman/decisions/2026-06-27-domain-example-reference-impl.md"
related_adrs:
  - "ADR-0008 (code-slim-strategy)"
related_decisions:
  - ".tinkerman/decisions/2026-06-27-domain-example-reference-impl.md（切片 A）"
  - ".tinkerman/decisions/2026-06-27-packs-plugin-distribution.md（切片 A'，已合并解除阻塞）"
related_specs:
  - ".tinkerman/specs/pms-pack-v1/（R4.5 state-machine 消费方，本 spec 让 mutation_critical_modules 变真实路径）"
