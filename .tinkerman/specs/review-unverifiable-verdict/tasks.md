...
layout: tasks
created: 2026-06-21
spec_ref: ".tinkerman/specs/review-unverifiable-verdict/requirements.md"
---
...
- **Definition of Done**: `npm run check` 全量通过;`bash scripts/check-spec-contract.sh .tinkerman/specs/review-unverifiable-verdict/requirements.md` 通过
