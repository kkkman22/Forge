...
layout: tasks
created: 2026-04-29
spec_ref: ".tinkerman/specs/community-ecosystem/requirements.md"
---
...
- [x] 4. Example projects and best practices
  - [x] 4.1 Create example frontend project (`examples/react-todo/`)
    - Include `.tinkerman/` directory with status.md, config.md
  ...
  - [x] 4.2 Create example backend project (`examples/node-api/`)
    - Include `.tinkerman/` directory with full configuration
