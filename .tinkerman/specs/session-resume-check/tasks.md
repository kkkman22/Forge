...
layout: tasks
created: 2026-06-04
spec_ref: ".tinkerman/specs/session-resume-check/requirements.md"
---
...
- [ ] 3.1 测试场景 A：`.tinkerman/status.md` 含 `phase: build` → 确认提醒出现
- [ ] 3.2 测试场景 B：`.tinkerman/status.md` 含 `phase: idle` → 确认静默
