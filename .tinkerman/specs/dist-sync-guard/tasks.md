...
layout: tasks
created: 2026-05-10
spec_ref: ".tinkerman/specs/dist-sync-guard/requirements.md"
---
...
- `package.json` (2 个脚本)
- `CONTRIBUTING.md` (新章节)
- `.tinkerman/knowledge/evolved-rules.md` (R6 + rule_count)
...
- [x] 4. Phase 1-2: 文件列表收集 + 临时 tsc 编译
  ...
  - [x] 4.3 `npx tsc --outDir .tinkerman/.dist-sync-check/` 编译到临时目录
  - [x] 4.4 计算 tracked dist 和 temp dist 的 SHA-256 checksums
  - [x] 4.5 确保 `.tinkerman/.dist-sync-check/` 在 finally 块清理
  - 引用：R1 AC1 (C), AC4
...
- [x] 12. evolved-rules R6 条目
  - [x] 12.1 `.tinkerman/knowledge/evolved-rules.md` frontmatter 更新 `rule_count: 5 → 6`
