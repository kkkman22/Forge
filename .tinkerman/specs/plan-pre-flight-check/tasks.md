...
layout: tasks
created: 2026-06-21
spec_ref: ".tinkerman/specs/plan-pre-flight-check/requirements.md"
---
...
- **Definition of Done**: `npm run check` 全量通过;`bash scripts/check-spec-contract.sh .tinkerman/specs/plan-pre-flight-check/requirements.md` 通过;现有无违规 plan 回归通过
