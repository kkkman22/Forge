...
hooks / agents) are retired to `.tinkerman/knowledge/solutions/evolved-rules-retired.md`.
...
**Prevents**: 把 "v1 stub 待实装" 的函数登记为 P2/P3 advisory 并 ship，导致"门禁看起来有，实际 no-op"（2026-05-10 审计：`loadOwnershipMap` 返回 `{}`，即使项目有 `.tinkerman/context-ownership.yaml` 也读不到；Context Boundary Hook 因此大多数情况 no-op）
...
**Source**: `.tinkerman/reviews/forge-single-entry-skills-collapse.md` P1-S1 + P1-S2; cross-ref `.tinkerman/knowledge/solutions/single-entry-dispatcher-collapse.md`; ADR-0004 §Decision/§Rollback
**Added**: 2026-05-17
**Confidence**: 0.9
...
**Source**: `.tinkerman/reviews/forge-kiro-style-spec-workflow-round2.md` + `round3.md` — 7 个 wire commits 全部 0 production caller
**Added**: 2026-05-23
**Confidence**: 0.9
...
**Source**: `.tinkerman/reviews/forge-kiro-style-spec-workflow-round3.md` §4.1
**Added**: 2026-05-23
**Confidence**: 0.9
**Last_triggered**: 2026-05-23
...
**Source**: `.tinkerman/reviews/forge-kiro-style-spec-workflow-round3.md` (P0-11)
**Added**: 2026-05-23
**Confidence**: 0.85
**Last_triggered**: 2026-05-23
...
**Source**: 2026-07-16 全量审核 `.tinkerman/audits/2026-07-16-full-project-audit.md` §系统性风险 SR-1
**Added**: 2026-07-16
**Confidence**: 0.9
...
`.tinkerman/knowledge/solutions/evolved-rules-retired.md` for historical reference:
