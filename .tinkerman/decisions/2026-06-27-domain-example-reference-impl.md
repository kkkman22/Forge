...
related_specs:
  - ".tinkerman/specs/pms-pack-v1/（R4.5 先天缺陷，本决策部分修正）"
  - ".tinkerman/specs/pack-system/"
related_decisions:
  - ".tinkerman/decisions/2026-06-26-arch-review-remediate-0626.md（T-01 state-machine 反转，本决策的直接源头）"
perspectives:
  product: "medium"
  architect: "medium"
  security: "low-medium"
