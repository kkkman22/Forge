...
layout: tasks
created: 2026-05-09
spec_ref: ".forge/specs/ddd-tactical-bdd-collaboration/requirements.md"
---
...
- [x] 8. PMS Pack 示例 ownership 映射
  ...
  - [x] 8.2 文档建议项目在 `.forge/context-ownership.yaml` 声明 glob → context 映射
...
- [x] 12. `src/living-doc/generator.ts` — 数据聚合
  ...
  - [x] 12.2 GREEN：实现 `generateLivingDoc(projectRoot, outputDir)`
    - 扫描 .forge/specs/*/spec.md
    - 调用 scenario-linter 的 parser（Sprint 1）提取 scenarios
    - 扫描 .forge/acceptance/*/report.md
...
- [x] 14. `/forge spec --living-doc` flag 集成
  ...
  - [x] 14.3 输出：✅ Living doc generated at .forge/docs/living/index.html (N scenarios)
  - 引用：R6.1
...
- [x] 30. README 与 CHANGELOG 更新
  ...
  - [x] 30.3 `.forge/knowledge/adr-index.md` 追加 Sprint 3 ADR
  - [x] 30.4 生成 ADR `.forge/decisions/ADR-NNNN-ddd-tactical-bdd.md`
