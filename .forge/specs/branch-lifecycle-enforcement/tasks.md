...
layout: tasks
created: 2026-04-29
spec_ref: ".forge/specs/branch-lifecycle-enforcement/requirements.md"
---
  ...
  - [x] 3.3 Update SKILL documents
    ...
    - **SKILL-纯函数对接验证**（防止重蹈 R6/R14 覆辙——函数写好但 SKILL 未引用）：
      ...
      - 检查清单：
        ...
        - `recordPendingDelivery(branchName, topic, timestamp)` → forge-ship SKILL 选项 3 中是否写明：调用此函数并将结果写入 `.forge/status.md` 或指定持久化位置
