...
layout: tasks
created: 2026-05-09
spec_ref: ".forge/specs/pms-pack-v1/requirements.md"
---
...
- [x] 8. `src/mutate.ts` — Stryker 包装
  ...
  - [x] 8.2 GREEN：实现 `runMutation(projectRoot, options)`
    ...
    - 计算 score，判定 verdict
    - 原子写 `.forge/mutation/<timestamp>.md`
...
- [x] 13. Skill 级 Hard Gate XML 化
  ...
  - [x] 13.5 `.forge/config.md` 的 frozen zone 声明包裹 `<HARD-GATE name="frozen-zone-protection">`
  - 引用：R10.2
...
- [x] 32. `scripts/init.sh` 支持 `--pack` 参数
  ...
  - [x] 32.2 写入 `.forge/config.md` frontmatter `packs:` 列表
...
- [x] 33. PMS 专属交互
  ...
  - [x] 33.3 写入 `.forge/config.md` frontmatter
  - [x] 33.4 创建 `.forge/custom/` 空目录
...
- [x] 36. 更新 README 与 CHANGELOG
  ...
  - [x] 36.3 `.forge/knowledge/adr-index.md` 追加 ADR 条目
  - [x] 36.4 生成 ADR `.forge/decisions/ADR-NNNN-pms-pack-v1.md`
