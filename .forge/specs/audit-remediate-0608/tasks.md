...
layout: tasks
created: 2026-06-08
spec_ref: ".forge/specs/audit-remediate-0608/requirements.md"
format: lightweight
...
echo "test" > .forge/reviews/test-guard.md
npx vitest run test/review/fallback-ladder.test.ts
test -f .forge/reviews/test-guard.md && echo "✅ 文件存在" || echo "❌ 文件被删除"
```
...
// line 284-297: 写入 .forge/findings/force-skip-review-<date>.md
```
