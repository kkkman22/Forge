...
layout: tasks
created: 2026-06-04
spec_ref: ".forge/specs/ce-inspired-review-enhancement/requirements.md"
---
...
- [ ] 1.6 在 `.forge/config.md` 增加 review 配置项
  ...
  **Verify-By**: `grep "review_" .forge/config.md` ≥ 4 处
  **关联需求**: R4.6, R3.6
...
- [ ] 4.2 在 `forge-review.md` 实现 Validation Pass
  ...
  - [ ] 结果记录到 `.forge/progress/<slug>-review-validation.jsonl`
...
- [ ] 5.4 创建 `.forge/docs/living/review-confidence-guide.md`
  - [ ] 置信度系统概述
  - [ ] 每个 reviewer 的校准指南摘要
