...
2. WHEN all research Subagents complete, THE Orchestrator SHALL merge their findings into `.forge/findings/<topic>.md`.
...
6. THE Build_Engine full-path research phase SHALL maintain the same findings output format in `.forge/findings/<topic>.md`.
