...
layout: tasks
created: 2026-06-07
spec_ref: ".forge/specs/partial-spec-backlog-remediation/requirements.md"
format: lightweight
---
...
| .forge/docs/partial-spec-satisfaction.md | MODIFY | T4 |
| .forge/specs/INDEX.md | REGENERATE | T5 |
...
2. Count manifest `command` / `args` entries and update `.forge/docs/partial-spec-satisfaction.md` metric if changed.
...
- `.forge/status.md` or `.forge/status/`
- `.forge/progress/`
...
```bash
rg "Superseded|不恢复|pms-pack-v1" .forge/docs/partial-spec-satisfaction.md
```

### GREEN

Update `.forge/docs/partial-spec-satisfaction.md` to:
...
```bash
git add .forge/docs/partial-spec-satisfaction.md .forge/specs/partial-spec-backlog-remediation .forge/specs/INDEX.md
