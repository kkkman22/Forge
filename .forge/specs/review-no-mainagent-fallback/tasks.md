...
layout: tasks
created: 2026-05-17
spec_ref: ".forge/specs/review-no-mainagent-fallback/requirements.md"
---
...
- [x] 1. Decide — ADR 草稿
  ...
  - Files: Create `.forge/decisions/<date>-review-fallback-ladder.md` (status: draft)
...
- [x] 11. ADR 定稿 + dist-plugin 同步
  - Files: Modify `.forge/decisions/<date>-review-fallback-ladder.md` (draft → accepted)；Run sync 脚本
  - Verify-By: bash
...
- 修复历史污染报告 `.forge/reviews/forge-single-entry-skills-collapse.md` → 单独 spec 处理
