...
This feature redefines the boundary between Spec documents (requirements.md, design.md, tasks.md) and Plan documents (`.forge/plans/<topic>.md`). Currently, each atomic task in a Plan contains full RED/GREEN/REFACTOR code blocks, duplicating much of what design.md already specifies. For large features (10+ requirements, 12+ property tests, 10+ file changes), writing a Plan is itself a massive effort.
...
graph TD
    ...
    subgraph "Document Layer (.forge/)"
        H --> J[.forge/plans/topic.md]
