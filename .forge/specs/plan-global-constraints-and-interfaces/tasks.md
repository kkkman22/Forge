...
layout: tasks
created: 2026-06-21
spec_ref: ".forge/specs/plan-global-constraints-and-interfaces/requirements.md"
---
...
- **Definition of Done**: `npm run check` 全量通过;`bash scripts/check-spec-contract.sh .forge/specs/plan-global-constraints-and-interfaces/requirements.md` 通过;现有 plan(无这两个块)回归解析不报错
