...
layout: tasks
created: 2026-06-29
spec_ref: ".forge/specs/glossary-enforcement-bridge/requirements.md"
...
- **Target**: glossary 来源从"扁平 .forge/glossary.md"改为"loadEnforcementGlossary（flat + enabled pack）"；保留 flat 写主权说明。
...
- **Depends On**: [4, 5]
- **Files**: `npm run check` 全绿 + `tsc -p tsconfig.build.json` + typedoc + dist resync + 写 `.forge/progress/glossary-enforcement-bridge.md`
