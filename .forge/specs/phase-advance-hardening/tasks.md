...
layout: tasks
created: 2026-05-08
spec_ref: ".forge/specs/phase-advance-hardening/requirements.md"
---
...
- [x] 1.1 在 `.forge/knowledge/evolved-rules.md` 追加 R3 条目（Sprint Is Not Phase Boundary），格式参考 design.md Component 3
...
- [x] 4.4 在 `.gitignore` 追加 `.forge/.stop-hook-dedupe/` 条目
...
- [x] 12.1 将 `.forge/plans/cmux-integration.md` 复制到 `test/fixtures/real-cases/cmux-integration-monolith.md`
...
- [x] 15.1 更新 `.forge/knowledge/glm-summary-ending.md` "实施优先级"章节，追加本 spec ID 和完成日期
...
- [x] 16.5 手动测试：构造一个 `.forge/` 状态模拟 plan-approved-build-not-started，通过 Claude Code 触发一次 Stop 事件，确认注入文本出现
