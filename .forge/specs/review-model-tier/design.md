...
| config 文件 | `.forge/config.md` | 无 review_model_tier_map 段 |
...
- `.forge/config.md` 加 review_model_tier_map 段。
...
2. 还原 `.forge/config.md`(删除 review_model_tier_map 段)。
