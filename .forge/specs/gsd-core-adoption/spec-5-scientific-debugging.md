...
Phase 1: Knowledge Base Check
  → 查询 .forge/knowledge/ 中的历史 bug 模式
...
写入：.forge/knowledge/debug-patterns.md
高频模式写入：.forge/knowledge/evolved-rules.md（附 Confidence Score 0.3-0.9）
```
