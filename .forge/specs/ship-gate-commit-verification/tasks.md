...
layout: tasks
created: 2026-05-01
spec_ref: ".forge/specs/ship-gate-commit-verification/requirements.md"
---
...
- [x] 2.2 Implement 4 cases: undefined commit → fresh; same commit → fresh; diff only .forge/ → fresh; project code changed → not fresh
...
- [x] 3.2 Define the comparison logic: same → pass, missing → pass (backward compat), diff only .forge/ → pass, project code → warning
