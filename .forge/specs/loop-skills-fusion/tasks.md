...
layout: tasks
created: 2026-04-28
spec_ref: ".forge/specs/loop-skills-fusion/requirements.md"
---
...
- [x] 7. CLI pre-flight checks
  - [x] 7.1 Implement pre-flight validation in forge-loop-cli
    - Add `.forge/` directory existence check (already partially done via `detectSkillAwareMode`)
  ...
  - [x] 7.2 Write unit tests for CLI pre-flight checks
    - Test missing `.forge/` directory outputs error and exits
