...
layout: tasks
created: 2026-05-17
spec_ref: ".forge/specs/review-subagent-concurrency/requirements.md"
---
...
- [x] 8. config.md 模板更新
  - Files: Modify `.forge/config.md`、`templates/.forge/config.md` (如有)
  - 格式：见 design.md §4
  - Verify-By: bash
  - Evidence: `grep "subagent_concurrency" .forge/config.md` 非空
  - 对应需求: R3.AC3
