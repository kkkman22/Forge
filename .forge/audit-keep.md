...
|---------|----------|---------|-------|
| agent-sdk-task-id-purge | `.forge/findings/agent-sdk-task-id-purge-2.1.143.md` | 每次 Claude Code 版本升级时重测 `/forge review`；上游 issue #14055/#25413/#27371/#29183 修复后可关闭 | 2026-05-17 |
