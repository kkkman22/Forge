...
- **Design Reference**: `design.md#component-1-forge-decide-teams-skill` — Execution Contract（env var、tmux、CC 版本检查）、Workflow（Agent(subagent_type="forge-decide-lead")调用）、.forge/runs 写入
- **Depends On**: Task 7
