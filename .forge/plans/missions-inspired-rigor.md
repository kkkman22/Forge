...
status: "approved"
date: "2026-05-16"
spec_ref: ".forge/specs/missions-inspired-rigor/spec.md"
format: "full"
---

# Plan: Missions-inspired Rigor

> 来源: `.forge/specs/missions-inspired-rigor/tasks.md`
...
- **R3 known-failures 基础设施需新建**：`src/known-failures.ts` + `.forge/knowledge/known-failures.md` 不存在
