...
| `design.md#error-handling` | fail-silent/fail-open 异常路径，.forge/status.md 缺失→exit 0 |
...
|-----------|-----------|-------------|
| `.forge/knowledge/evolved-rules.md` | MODIFY | 追加 R3 条目，rule_count 2→3 |
...
| `.gitignore` | MODIFY | 追加 `.forge/.stop-hook-dedupe/` |
...
- **File**: `.forge/knowledge/evolved-rules.md`
...
- **Depends On**: (none)
- **Verify**: `grep -c '### R3:' .forge/knowledge/evolved-rules.md` 返回 1，frontmatter `rule_count: 3`
