...
| File Path | Operation | Description |
|-----------|-----------|-------------|
| `.forge/knowledge/skill-style-guide.md` | CREATE | 风格指南主文档（开放区） |
...
| `.forge/findings/scripts-help-audit.md` | CREATE | 27 个脚本分类审计结果 |
...
| `.forge/knowledge/skill-style-guide.md` | MODIFY | 引用 Scripts as Black Box 纪律 |
...
| `.gitignore` | MODIFY | 追加 .forge/cache/ |
...
| `scripts/prune-event-logs.sh` | MODIFY | 扩展覆盖 .forge/reviews/assets/ |
...
- **File**: `.forge/knowledge/skill-style-guide.md`
...
- **File**: `.forge/knowledge/skill-style-guide.md` (section 8)
...
- **File**: `.forge/knowledge/skill-style-guide.md` (section 9)
...
#### Task 17: 编写快速核对清单
- **Goal**: ≤10 条 PR 自检清单
- **File**: `.forge/knowledge/skill-style-guide.md` (section 10)
...
- **File**: `.forge/findings/scripts-help-audit.md`
...
- **Goal**: 追加 .forge/cache/ 条目
- **File**: `.gitignore`
- **Design Ref**: `design.md#5.7` — 登录态缓存
- **Depends On**: (none)
- **Verify**: grep ".forge/cache/" .gitignore
- **Commit**: `chore: add .forge/cache/ to .gitignore`
...
- **Goal**: .forge/reviews/assets/ 30 天自动归档
