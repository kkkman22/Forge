...
> 来源: 拆分自 `.forge/plans/pms-pack-v1.md`（用户选择 split-into-3）
...
| `.forge/knowledge/adr-index.md` | MODIFY | ADR 条目 |
| `.forge/decisions/ADR-NNNN-pms-pack-v1.md` | CREATE | ADR 文档 |
...
#### Task 8: PMS 专属交互流程
- **Goal**: --pack pms 时提示 cutoff_hour/timezone，创建 .forge/custom/，打印欢迎消息
- **File**: `scripts/init.sh`
