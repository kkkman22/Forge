...
| `.forge/decisions/ADR-0003-single-entry-command-consolidation.md` | CREATE | ADR |
...
**Depends On**: ["5"]
**Files**:
- Create: `.forge/decisions/ADR-0003-single-entry-command-consolidation.md`
- Modify: `.forge/decisions/2026-05-12-plugin-distribution.md`
