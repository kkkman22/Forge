...
| `design.md#4-3-src-pack-config-ts` | 项目级 Pack 启用，解析 .forge/config.md frontmatter |
...
- **Goal**: 实现 parseEnabledPacks，解析 .forge/config.md frontmatter packs 字段
...
- **Design Reference**: `design.md#4-7-src-glossary-registry-ts` — 文件名即 context，多 ## Term 段，空输入回退 .forge/glossary.md
