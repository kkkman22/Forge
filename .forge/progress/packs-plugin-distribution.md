...
> Plan: `.forge/specs/packs-plugin-distribution/tasks.md` (status: locked)
> Spec: `.forge/specs/packs-plugin-distribution/requirements.md` (status: locked)
> Decision: `.forge/decisions/2026-06-27-packs-plugin-distribution.md`
