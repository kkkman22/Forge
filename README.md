...
| 命令速查 | [docs/reference-commands.md](docs/reference-commands.md) | 查看全部 18 个命令和路由详解 |
...
**测试策略**：5066 个测试（280 个测试文件，其中 133 个为 fast-check 属性测试文件）验证不变量。覆盖率 ~89% statements。
