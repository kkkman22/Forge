...
function showHelp() {
  console.log(`Usage: node scripts/tinkerman-phase-worker.mjs --phase <phase> --run-id <id> --project-root <path> --artifact <path> --summary <path>

Internal Forge CLI/SDK phase worker. Normally invoked by /tinkerman runtime.`);
}
