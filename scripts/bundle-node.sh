...
# Downloads macOS Universal Binary, strips unnecessary files

NODE_VERSION="v24.15.0"
PLATFORM="darwin"
ARCH="universal"  # arm64 + x64 combined
BASE_URL="https://nodejs.org/dist/${NODE_VERSION}"
TAR_NAME="node-${NODE_VERSION}-${PLATFORM}-x64.tar.gz"
RESOURCES_DIR="${1:-apps/forge-loop-desktop/src-tauri/resources}"

NODE_DIR="${RESOURCES_DIR}/node"

echo "==> Bundling Node.js ${NODE_VERSION} for macOS..."
