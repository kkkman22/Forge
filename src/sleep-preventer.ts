 ...
 */
export function buildCaffeinateCommand(pid: number): SleepPreventionCommand {
  return {
    command: "caffeinate",
    args: ["-i", "-w", String(pid)],
    detached: false,
 ...
 */
export function buildSystemdInhibitCommand(
  execPath: string,
  execArgv: string[],
  scriptPath: string,
  argv: string[],
 ...
 */
export function buildPowerShellCommand(pid: number): string {
  return [
    "Add-Type @'",
    "using System;",
 ...
 */
export function buildSleepPreventionCommand(
  platform: string,
  pid: number,
): SleepPreventionCommand | null {
