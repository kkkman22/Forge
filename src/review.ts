...
/**
 * Per-agent maxTurns configuration, matching .claude/agents/*.md frontmatter.
 *
 * spec-check needs more turns (reads spec + plans + tasks).
...
// ---------------------------------------------------------------------------
// Fallback Ladder Implementation (R1, R2, R3, R5)
// ---------------------------------------------------------------------------
