 ...
 */
export function computeWorktreeDir(repoRoot: string): string {
 ...
 */
export function computeWorktreePath(repoRoot: string, slug: string): string {
 ...
 */
export function decideWorktreeCleanup(commitCount: number): WorktreeDecision {
  if (commitCount > 0) {
    return {
      action: "preserve",
