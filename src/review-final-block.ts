...
const AGENT_LAYER_HEADING: Record<string, RegExp> = {
...
export type FinalBlockReason =
  | "empty-output"
  | "missing-final-block"
  | "missing-severity-table"
  | "missing-sentinel"
  | "wrong-layer"
  | "sentinel-not-at-end";
 ...
 * @public
 */
export function validateFinalReportBlock(
  output: string | undefined,
  agentType: string,
): FinalBlockValidation {
 ...
 * @public
 */
export function enforceFinalReportContract(result: SubagentResult): SubagentResult {
